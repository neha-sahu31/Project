...
class admin:
    food_item_list = {1 :{'Name' : 'Tandoori Chicken' , 'Quantity' : '4 Piece' , 'Price' : 240 , 'Discount(%)' : 10 , "Stock" : 50}, 
                 2 :{'Name' : 'Vegan Burger' , 'Quantity' : '1 Piece' , 'Price' : 320 , 'Discount(%)' : 5 , "Stock" : 30}, 
                 3 :{'Name' : 'Truffle Cake' , 'Quantity' : '500gm' , 'Price' : 900 , 'Discount(%)' : 5 , "Stock" : 25}}
    user_details = {}
    user_login =[]
    admin_details = {}
    count =3
    ...
    def admin_home(self):
        self.start_action = input("Press 1 for Admin Page \nPress 2 for User Page\n")
...
class user(admin):
    ...
    def __init__(self):
        print("Welcome! Order Food Fresh! ")
        time.sleep(1)
        self.admin_home()
    ...
    # view the option to place new order/ order history/ update profile for logged in user
